...
pub type TrailGeometryRequests = SharedResourceRequests<LoadedTrailPath<PackMapPath>, LoadResult<LoadedTrailGeometry>>;
pub type TrailGeometryRequestsTx =
    SharedResourceRequestsTx<LoadedTrailPath<PackMapPath>, LoadResult<LoadedTrailGeometry>>;
pub type TextureLoadRequests = SharedResourceRequests<LoadedMarkerPath<PackMapPath>, LoadResult<TextureKey>>;
