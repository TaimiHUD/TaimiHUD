...
impl FestivalFixup {
    ...
    pub const FESTIVAL_CATEGORIES: &'static [(&'static str, Festival)] = &[
        (
            "tw_guides.tw_festivals.tw_festival_wintersday",
            Festival::Wintersday,
        ),
        ("tw_guides.tw_festivals.tw_sab", Festival::SuperAdventureBox),
        (
            "tw_guides.tw_festivals.tw_festival_halloween",
            Festival::Halloween,
        ),
        (
            "tw_guides.tw_festivals.tw_festival_dragonbash",
            Festival::DragonBash,
        ),
        (
            "tw_guides.tw_festivals.tw_festival_fourwinds",
            Festival::FourWinds,
        ),
        (
            "tw_guides.tw_festivals.tw_festival_lunarnewyear",
            Festival::LunarNewYear,
        ),
        (
            "reactif.festivals.super_adventure_box",
