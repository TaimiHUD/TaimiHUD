use {
    ...
    }, crate::{controller::ControllerEvent, marker::atomic::MarkerInputData, render::pathing_window::{PathingFilterState, PathingSearchState}, CONTROLLER_SENDER}, bitvec::vec::BitVec, indexmap::IndexMap, nexus::imgui::{Condition, TreeNode, Ui}, std::{
