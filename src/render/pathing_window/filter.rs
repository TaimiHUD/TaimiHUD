use {
    ...
    crate::{
        exports::runtime::imgui::{self, Selectable, Ui},
        render::{element::pack::CategorySearchQuery, machine::RenderMachine},
...
impl PathingWindowState {
    pub fn draw_filters(&mut self, ui: &Ui, machine: &mut RenderMachine) -> Option<bool> {
        let pushy = ui.push_id("pathing-search");
        let mut search_dirty = with_i18n!("search", |label| ui
