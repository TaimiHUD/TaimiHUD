use {
    super::RenderMachine,
    crate::{
        render::element::im::{DrawContextInput, UiContextStorage},
...
impl RenderMachine {
    ...
    pub(super) fn ui_publish_report(report: &UiStateReport) {
        Self::ui_published_captured_keyboard().store(
            InterfaceParty::opt_repr(report.captured_keyboard),
            Self::UI_REPORT_ORD_PUBLISH,
        );
    }
    #[inline]
