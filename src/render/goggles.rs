...
impl GogglesConfig {
    ...
    pub fn draw_project_options(&self, ui: &Ui, machine: &mut RenderMachine) {
        use {
    ...
    pub fn draw_debug_toggles(&mut self, ui: &Ui, machine: &mut RenderMachine) {
        #[cfg(feature = "goggles2-project")]
        if machine.goggles.enabled_config.contains(GogglesEnables::PROJECT_ENABLE) {
    ...
    pub fn draw_debug_lens2(&mut self, ui: &Ui, machine: &mut RenderMachine) {
...
pub fn enable(needs_setup: bool) -> bool {
