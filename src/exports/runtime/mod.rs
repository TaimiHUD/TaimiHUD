...
pub(crate) fn setup_stats() {
    ...
    {
        statistics::StatsRef::new(&self::allocator::STATS_ALLOC_SIZE, statistics::StatsUnit::Size)
            .register(statistics::StatsDesc::new("stats-runtime-allocator", "stats-runtime-alloc"))
    }
}
