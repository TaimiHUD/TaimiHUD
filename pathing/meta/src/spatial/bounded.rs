...
impl PointDistance<<LocalSpace as Unit>::Scalar, 2> for TriggerBoundsInfo<LocalSpace>
where
    ...
    LocalPoint2: MintConv<MintNalg = nalgebra::Point2<<LocalSpace as Unit>::Scalar>>,
{
    ...
    fn distance_squared(
        &self,
        query: nalgebra::Point<<LocalSpace as Unit>::Scalar, 2>,
    ) -> <LocalSpace as Unit>::Scalar {
